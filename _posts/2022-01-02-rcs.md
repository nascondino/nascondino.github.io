...
The *Android version* required the victim to enable installation of applications from unknown sources, and didn't contained any 0-days out-of-the-box but the code contained hints about such capabilities.[[3](#external-references)]

The "Hermit" spyware was deployed in Kazakhstan and Syria, both countries with poor human rights records, and Italy.[[4](#external-references)]
...
4. [theguardian.com](https://www.theguardian.com/technology/2022/jun/23/apple-and-android-phones-hacked-by-italian-spyware-says-google)
